...
export const AUDIT_SECTION_GROUPS: Record<string, string[]> = {
    ...
    'Financiers': ['FINANCIAL_CREATED', 'FINANCIAL_UPDATED', 'FINANCIAL_STATEMENT_SAVED', 'NORMALIZATION_SAVED', 'ADJUSTMENT_ADDED'],
    'Analyse': ['RATIO_COMPUTED', 'INTERPRETATION_SAVED', 'STRESS_TEST_COMPUTED'],
    'Scoring': ['SCORECARD_COMPUTED', 'OVERRIDE_ADDED', 'OVERRIDE_CANCELLED', 'EXPERT_REVIEW_SUBMITTED'],
