...
export class FinancialService {
  ...
  createFinancialStatement(
    ...
    return this.http.post<FinancialStatementRawOut>(`${this.apiUrl}/${caseId}/financials`, payload);
  }
  ...
  deleteFinancialStatement(caseId: string, statementId: string): Observable<void> {
    return this.http.delete<void>(`${this.apiUrl}/${caseId}/financials/${statementId}`);
  }
