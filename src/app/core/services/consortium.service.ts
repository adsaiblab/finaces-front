...
export class ConsortiumService {
  ...
  updateMember(
    caseId: string,
    memberId: string,
    payload: Partial<ConsortiumMemberCreate>,
  ): Observable<ConsortiumScorecardOutput> {
    return this.http.patch<ConsortiumScorecardOutput>(
      `${this.apiUrl}/${caseId}/consortium/members/${memberId}`,
      payload,
    );
  }

  removeMember(caseId: string, memberId: string): Observable<ConsortiumScorecardOutput> {
    return this.http.delete<ConsortiumScorecardOutput>(
      `${this.apiUrl}/${caseId}/consortium/members/${memberId}`,
    );
  }
