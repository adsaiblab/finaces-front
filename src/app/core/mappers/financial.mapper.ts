  ...
  static toApi(
    ...
    return {
      ...
      balance_sheet_assets: {
        total_assets: forms.assets.totalAssets,
        current_assets: forms.assets.currentAssetsTotal,
      ...
      balance_sheet_liabilities: {
        total_liabilities: forms.liabilities.totalLiabilities,
        current_liabilities: forms.liabilities.currentLiabilitiesTotal,
        long_term_debt: forms.liabilities.longTermDebt || 0,
        equity: forms.liabilities.equityTotal,
