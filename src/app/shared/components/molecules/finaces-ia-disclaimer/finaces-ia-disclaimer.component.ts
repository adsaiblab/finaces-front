...
export class FinacesIaDisclaimerComponent {
    ...
    public readonly disclaimerText = 'This AI scoring is a NON-DECISIONAL challenger tool. It does not replace the official MCC score.';
    public readonly pilotModeText = 'AI Pilot Mode: Experimental results, for informational purposes only.';
