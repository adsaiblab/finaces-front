...
export class CasesListComponent {
  ...
  private loadHubMock(): void {
    ...
    const MOCK_DATA: HubCase[] = [
      {
        id: 'ca-9871x-12po',
        bidder_name: 'DurocDynamics GmbH',
        updated_at: '2026-03-26T09:12:00Z',
        assignee: 'Analyst A.',
        steps: buildSteps('COMPLETED', 'COMPLETED', 'ACTIVE', 'LOCKED', 'LOCKED'),
      },
      {
        id: 'ca-1029y-90al',
        bidder_name: 'Titan Constructors',
        updated_at: '2026-03-25T14:30:00Z',
        assignee: 'Analyst B.',
        steps: buildSteps('COMPLETED', 'COMPLETED', 'COMPLETED', 'ACTIVE', 'LOCKED'),
      },
      {
        id: 'ca-0912x-77wq',
        bidder_name: 'Nexus Infrastructure',
        updated_at: '2026-03-26T11:00:00Z',
        assignee: 'Unassigned',
        steps: buildSteps('ACTIVE', 'LOCKED', 'LOCKED', 'LOCKED', 'LOCKED'),
      },
      {
        id: 'ca-4458z-88tr',
        bidder_name: 'NovaTech Supplies',
        updated_at: '2026-03-24T16:45:00Z',
        assignee: 'Drift Ops',
        steps: buildSteps('COMPLETED', 'ACTIVE', 'LOCKED', 'LOCKED', 'LOCKED'),
      },
      {
        id: 'ca-8831y-55mn',
        bidder_name: 'Aeris Holdings',
        updated_at: '2026-03-20T10:15:00Z',
        assignee: 'Analyst A.',
        steps: buildSteps('COMPLETED', 'COMPLETED', 'COMPLETED', 'COMPLETED', 'ACTIVE'),
      },
    ];
