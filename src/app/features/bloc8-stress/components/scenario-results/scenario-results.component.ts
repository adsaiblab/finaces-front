...
import {
  ...
  ScenarioFlowSchema,
} from '../../../../shared/components/organisms/finaces-stress-chart/finaces-stress-chart.component';
...
export class ScenarioResultsComponent {
  ...
  public getStatusClass(status: string): string {
    if (status === 'RESILIENT')
      return 'text-[color:var(--color-success)] bg-[color:var(--color-success)] bg-opacity-10';
    if (status === 'MARGINAL')
      return 'text-[color:var(--color-warning)] bg-[color:var(--color-warning)] bg-opacity-10';
