...
describe('GateComponent', () => {
  ...
  let mockCaseService: {
    getCaseDetail: ReturnType<typeof vi.fn>;
    evaluateGate: ReturnType<typeof vi.fn>;
    patchCaseStatus: ReturnType<typeof vi.fn>;
  };
  let mockDocumentService: {
    getGateDocuments: ReturnType<typeof vi.fn>;
    uploadGateDocument: ReturnType<typeof vi.fn>;
  ...
  beforeEach(async () => {
    ...
    mockCaseService = {
      getCaseDetail: vi.fn().mockReturnValue(
        of({
          id: '1',
          name: 'Test Case',
      ...
      evaluateGate: vi.fn().mockReturnValue(
        of({
          id: 'dec-1',
          case_id: '1',
          verdict: 'PASSED',
  ...
  it('devrait sceller le gate et naviguer', async () => {
    ...
    expect(mockCaseService.patchCaseStatus).toHaveBeenCalledWith('1', {
      new_status: 'FINANCIAL_INPUT',
    });
