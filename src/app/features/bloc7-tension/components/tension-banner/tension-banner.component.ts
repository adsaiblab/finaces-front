    ...
    switch (this.level()) {
      case TensionLevel.SEVERE:
        return {
          icon: 'warning',
          classes:
            'bg-[color:var(--color-error)] bg-opacity-10 border-[color:var(--color-error)] text-[color:var(--color-error)]',
      ...
      case TensionLevel.MODERATE:
        return {
          icon: 'report_problem',
          classes:
            'bg-[color:var(--color-warning)] bg-opacity-10 border-[color:var(--color-warning)] text-[color:var(--color-warning)]',
      ...
      case TensionLevel.MILD:
        return {
          icon: 'info',
          classes:
            'bg-[color:var(--color-info)] bg-opacity-10 border-[color:var(--color-info)] text-[color:var(--color-info)]',
      ...
      default:
        return {
          icon: 'check_circle',
          classes:
            'bg-[color:var(--color-success)] bg-opacity-10 border-[color:var(--color-success)] text-[color:var(--color-success)]',
