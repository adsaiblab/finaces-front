...
export class ComparativeTableComponent {
    ...
    public dataSource = computed<ComparativeRow[]>(() => {
        ...
        const rows: ComparativeRow[] = [
            ...
            this.buildRow('Cash & Equivalents', 123456, rawData.normalized_bilan_actif?.liquid_assets || 123456, 1),
            ...
            this.buildRow('Other Non-Current Assets', 567890, rawData.normalized_bilan_actif?.other_noncurrent_assets || 612345, 1, 'Δ'),
            { id: 't3', label: 'TOTAL ASSETS', rawValue: 4086416, normalizedValue: rawData.normalized_bilan_actif?.total_assets || 4208787, deltaAmount: 122371, deltaPct: 3.0, note: '', isTotal: true, indentLevel: 0 },

            { id: 'h3', label: 'EQUITY', rawValue: 0, normalizedValue: 0, deltaAmount: 0, deltaPct: 0, note: '', isHeader: true, indentLevel: 0 },
            { id: 't4', label: 'Total Equity', rawValue: 1000000, normalizedValue: rawData.normalized_bilan_passif?.equity || 1050000, deltaAmount: 50000, deltaPct: 5.0, note: '', isTotal: true, indentLevel: 0 },

            { id: 'h4', label: 'CURRENT LIABILITIES', rawValue: 0, normalizedValue: 0, deltaAmount: 0, deltaPct: 0, note: '', isHeader: true, indentLevel: 0 },
            { id: 't5', label: 'Total Current Liabilities', rawValue: 2600000, normalizedValue: rawData.normalized_bilan_passif?.current_liabilities || 2450000, deltaAmount: -150000, deltaPct: -5.8, note: '', isTotal: true, indentLevel: 0 },
            ...
            { id: 't7', label: 'TOTAL LIABILITIES & EQUITY', rawValue: 5100000, normalizedValue: rawData.normalized_bilan_passif?.total_liabilities || 5150000, deltaAmount: 50000, deltaPct: 1.0, note: '', isTotal: true, indentLevel: 0 },
        ];
