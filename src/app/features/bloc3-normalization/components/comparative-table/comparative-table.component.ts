...
export class ComparativeTableComponent {
  ...
  public dataSource = computed<ComparativeRow[]>(() => {
    ...
    return [
      ...
      r('Net Financial Result', (d.financial_income_original ?? 0) - (d.financial_expenses_original ?? 0), (d.financial_income ?? 0) - (d.financial_expenses ?? 0), 2),
      r('Financial Income', d.financial_income_original, d.financial_income, 3),
