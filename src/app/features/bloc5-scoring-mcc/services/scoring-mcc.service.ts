...
export class ScoringMccService {
   ...
   */
  public getExistingScoring(caseId: string): Observable<ScorecardOutputSchema> {
    return this.http.get<ScorecardOutputSchema>(`${this.apiUrl}/${caseId}/score`).pipe(
   ...
   */
  public computeScoring(caseId: string): Observable<ScorecardOutputSchema> {
    return this.http.post<ScorecardOutputSchema>(`${this.apiUrl}/${caseId}/score`, {}).pipe(
  ...
  ): Observable<ScorecardOutputSchema> {
    return this.http
      .post<ScorecardOutputSchema>(`${this.apiUrl}/${caseId}/score/override`, payload)
      .pipe(
